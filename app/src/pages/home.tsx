  ...
  return (
    <div className="flex items-center justify-center gap-10 w-full h-full">
      <div className="flex flex-col gap-4 w-[400px]">
        <input
          type="text"
          className="bg-white text-lg p-4 rounded-xl outline-none border-2 border-indigo-500"
        ...
        <Link to={`/soll/${pollKey}`}>
          <button
            disabled={!pollKey}
            className="bg-indigo-500 disabled:bg-gray-500 disabled:cursor-not-allowed text-white rounded-xl p-4 w-full font-semibold text-xl"
          >
            Join Poll {pollKey}
          </button>
        </Link>
